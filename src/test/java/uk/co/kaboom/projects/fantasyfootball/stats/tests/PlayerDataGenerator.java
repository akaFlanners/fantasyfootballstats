...
public class PlayerDataGenerator {
     ...
     public static Player getPlayer() {
         ...
         player.setAssists("1");
         player.setBonus("2");
         player.setCleanSheets("3");
         player.setEaSportsPPI("4");
         player.setForm("5");
         player.setGoalsConceded("6");
         player.setGoalsScored("7");
         player.setGw("8");
         player.setMinutesPlayed("9");
         player.setOwnGoals("10");
         player.setPenaltiesMissed("11");
         player.setPenaltiesSaved("12");
         player.setPlayer("13");
         player.setPlayerIndex("14");
         player.setPointsPerGame("15");
         player.setPos("16");
         player.setPrice("17");
         player.setPriceFall("18");
         player.setPriceFallRound("19");
